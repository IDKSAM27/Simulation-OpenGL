...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(800, 800, "SimulationOpenGL", NULL, NULL);
	...
	// Links VBO attribute such as coordinates and colors to VAO
	...
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST); // There are two types of filter or.. for the image or texture one is GL_NEAREST and GL_LINEAR, we choose GL_NEAREST
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// Assigns a value to the uniform; NOTE: Must always be done after activating the ShaderProgram
